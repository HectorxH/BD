...
legal_views = ['poyo', 'sansanito', 'legendarios', 'mas_prioridad', 'menos_prioridad']
...
def drop_views():
    for view in legal_views[1:]:
        try:
            cnxn.execute("DROP VIEW {};".format(view))
        except:
